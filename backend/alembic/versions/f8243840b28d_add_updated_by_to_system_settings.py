...
def upgrade() -> None:
    ...
    op.add_column('system_settings', sa.Column('updated_by', sa.Integer(), nullable=True))
    op.create_foreign_key(None, 'system_settings', 'users', ['updated_by'], ['id'])
    
    op.alter_column('system_settings', 'rate_limit',
               existing_type=postgresql.JSON(astext_type=sa.Text()),
               nullable=True)
    op.alter_column('system_settings', 'security',
               existing_type=postgresql.JSON(astext_type=sa.Text()),
               nullable=True)
    op.alter_column('system_settings', 'models',
               existing_type=postgresql.JSON(astext_type=sa.Text()),
               nullable=True)
    op.alter_column('system_settings', 'monitoring',
               existing_type=postgresql.JSON(astext_type=sa.Text()),
               nullable=True)
    op.alter_column('system_settings', 'beta_features',
               existing_type=postgresql.JSON(astext_type=sa.Text()),
               nullable=True)
...
def downgrade() -> None:
    ...
    op.add_column('usage_records', sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False))
