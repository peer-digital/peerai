...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['created_by_id'], ['users.id'], name=op.f('fk_teams_created_by_id_users')),
    ...
    op.alter_column('usage_records', 'user_id',
               existing_type=sa.INTEGER(),
               nullable=True)
    op.alter_column('usage_records', 'api_key_id',
               existing_type=sa.INTEGER(),
               nullable=True)
