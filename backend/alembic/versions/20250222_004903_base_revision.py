...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "is_superuser", sa.Boolean(), nullable=True, server_default=sa.text("false")
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "daily_limit", sa.Integer(), nullable=True, server_default=sa.text("1000")
        ),
        sa.Column(
            "minute_limit", sa.Integer(), nullable=True, server_default=sa.text("60")
        ),
        sa.Column(
            "created_at", sa.DateTime(), nullable=False, server_default=sa.text("now()")
        ),
